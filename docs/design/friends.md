...
- **It is the end of that ask.** The add stays in the table and stops being
  ...
  [decision 78](../architecture/decisions.md) took that list off the page and
...
([decision 78](../architecture/decisions.md)):
...
**Adding** is the field, and since decision 78 it is the only way to make an
...
name adds that pilot by number. The cost is written down in decision 78.
...
It answered with three more lists until decision 78, and they went from the
