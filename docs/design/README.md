...
| [ships.md](ships.md) | The seven ships: what each one flies, fires and carries, the footprints they present, and the design rules behind them |
...
| [zones.md](zones.md) | The games planned beside Team Battle: duel, War, Turf and free roam, what each asks of the engine, and why no mode framework is coming |
