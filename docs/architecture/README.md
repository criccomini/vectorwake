...
| [playtest-harness.md](playtest-harness.md) | Playing the shipped client like a person: the localhost stage, the probe, real input on four device profiles, the journeys and the oracles. Built, in `harness/`; the monkey and the player are not |
