...
/// arena again, how often account login had to be retried, and how often a
/// shared driver needed replacement. Reconnects are what an arena restart
/// looks like from here. Driver restarts are the bot process repairing its own
/// simulation clock.
