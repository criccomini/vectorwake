...
read_globals = {
    ...
    -- `webtransport` by client/ext/webtransport, on HTML5 builds only,
    -- which is why net.lua fetches it with rawget rather than naming it.
    "sim", "vwbuf", "vwsfx", "websocket", "webtransport",
}
...
files["client/tests/*.lua"] = {
    globals = {"sim", "vwbuf", "vwsfx", "websocket", "webtransport", "buffer",
               "go", "hash", "resource", "sound", "sys", "html5"},
}
