...
check("and counted where a pilot holds more than one",
      prize.words(1, 3) == "recharge x3", prize.words(1, 3))
...
check("and counts above one",
      prize.words(8, 2) == "gun bounce x2", prize.words(8, 2))
...
check("and counted", prize.words(20, 2) == "burst x2", prize.words(20, 2))
