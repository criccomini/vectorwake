...
do
    ...
    -- Sitting out is the page past the roster: a name, with the badge a seat
    -- wears standing where a hull would be.
    ...
    -- And it draws something, which for five decisions it did not: the row
    -- keeps a hull's whole height whether or not there is a hull to put in
    -- it, so the word sat under an empty space with an arrow either side of
    -- it. What stands there now is the badge a seat wears when a person is
    -- in it, which is nine closed shapes: three of hull and three feathers a
    -- side. See decision 135.
    ...
    check("as wide as the circle a hull is drawn in",
          bx1 - bx0 > 30 and bx1 - bx0 < 44,
