...
-- room you were in. The second is gone with decision 129, and what replaces
...
do
    ...
    -- out was the page past the roster until decision 129, so one more step
    ...
    -- more (decision 129), so it has nothing to say about it.
    menu.watching = true
