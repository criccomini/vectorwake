...
local function frame(touching)
    ...
    -- The text goes to the edges too: POS is among the topmost things on
    -- screen, and text is not a shape. It rides the same bottom-up frame the
    -- mesh does, so it flips through H the same way.
    for k = 1, state.n do
