...
local function roster(seats, watchers)
    ...
    for _, s in ipairs(seats) do
        ...
        -- assists(2), then the name's length. The scores joined the roster
        -- when snapshots stopped carrying every seat: a board has to be able
        -- to name and score a pilot it is not being shown.
