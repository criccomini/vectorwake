...
-- wear is therefore drawn at least once here, and a mark that throws is a menu
-- that will not open. The change before this shipped a crash in a drawing path
-- no test ever ran.
