...
-- type inside it, and the two are not the same number. A row centers its name
-- in a field tall enough for a sentence and a strip of figures under it, and a
-- section label sits near the top of a head a third that height, so these do
-- not agree exactly and should not be made to. What they must not do is
