...
|---|---|---|
| `all` | Caddy, central, arena | Client payload, directory, meta-layer, arena, bots |
| `central` | Caddy, central | Client payload, directory, meta-layer |
...
That DNS change causes the replacement to request the certificate for the public name. Read the prompt and the existing TTL before confirming it.
